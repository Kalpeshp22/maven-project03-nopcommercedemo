package com.nopcommerce.demo.small.pages;

import com.nopcommerce.demo.small.utility.Utility;
import org.openqa.selenium.By;

public class TopMenuPage extends Utility {  By computerTab = By.partialLinkText("Computers");
